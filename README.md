...
- **Тестирование**: Vitest (**75 test suites, 639 tests**, Golden Tests ГОСТ 34, Eval Suite LLM, JUnit XML reporter).
...
# Запуск полного набора юнит, интеграционных и eval-тестов (75 сьютов, 639 тестов)
npm test
