...
Для типовых проектов ИБ предусмотрены отдельные внедренческие шаблоны **SIEM / SOC**, **IDM / IGA** и **NGFW** с количественными драйверами оценки, этапами, требованиями и рисками. Практическая схема применения, входные данные и критерии приемки описаны в [`docs/IMPLEMENTATION_TEMPLATES.md`](docs/IMPLEMENTATION_TEMPLATES.md).
