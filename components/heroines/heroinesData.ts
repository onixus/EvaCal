...
export const HEROINES: Heroine[] = [
  {
    ...
    description: 'Верховная чародейка тёмного кодекса в бархатном корсете и с аметистовым чокером. Её взор пронзает сложные интеграции и микросервисы.',
    quotes: [
  ...
  },
  {
    ...
    description: 'Дева битвы с фиолетовыми локонами в резном чешуйчатом панцире. Её холодный расчет защищает бюджет и дедлайны проекта.',
    quotes: [
  ...
  },
  {
    ...
    description: 'Лунная жрица в струящемся бирюзовом платье с кулоном-полумесяцем. Её священный лунный свет освящает документацию по ГОСТ.',
    quotes: [
  ...
  },
  {
    ...
    description: 'Обольстительница вероятностей с ониксовыми рожками в соблазнительном черном кружеве с рубиновым сердцем. Убеждает любого заказчика подписать контракт.',
    quotes: [
