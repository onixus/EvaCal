    ...
    <div className="space-y-4 animate-in fade-in duration-150">
      <div className={`${PANEL_CLASS} space-y-3`}>
        ...
        {!isReviewLoading && stages.length === 0 && (
          <div className="text-xs text-amber-900 bg-amber-50 border border-amber-300 dark:text-amber-300 dark:bg-amber-500/10 dark:border-amber-500/30 rounded-lg px-3 py-2">
