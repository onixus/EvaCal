...
export default function TotalsSummary({ stages, pmHours, risks }: Props) {
  ...
  return (
    <dl className="grid grid-cols-2 gap-x-6 gap-y-1 text-sm sm:grid-cols-4">
      <div>
        <dt className="text-xs uppercase tracking-wide text-slate-500 dark:text-nord-3">Этапы</dt>
        <dd>{stagesHours} ч</dd>
      </div>
      <div>
        <dt className="text-xs uppercase tracking-wide text-slate-500 dark:text-nord-3">РП</dt>
        <dd>{pmHours} ч</dd>
      </div>
      <div>
        <dt className="text-xs uppercase tracking-wide text-slate-500 dark:text-nord-3">Риски</dt>
        <dd>{risksHours} ч</dd>
      </div>
      <div>
        <dt className="text-xs uppercase tracking-wide text-slate-500 dark:text-nord-3">Итого</dt>
