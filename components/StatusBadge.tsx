...
const COLORS: Record<string, string> = {
  draft: "bg-slate-100 text-slate-600 dark:bg-nord-2 dark:text-nord-4",
  ...
  planned: "bg-slate-100 text-slate-600 dark:bg-nord-2 dark:text-nord-4",
  ...
  rejected: "bg-rose-100 text-rose-700 dark:bg-nord-red/20 dark:text-nord-red",
};
