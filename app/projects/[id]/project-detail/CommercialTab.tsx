...
export default function CommercialTab({
  ...
  calculation: SerializedCalculation | null;
}) {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        {calculation && (
          <Link href={`/calculations/${calculation.id}`} className="btn-secondary text-xs">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="card p-5 space-y-4">
            ...
            <div className="divide-y divide-slate-100 dark:divide-nord-3 text-sm">
              ...
              <div className="flex justify-between py-2">
                <span className="text-slate-600 dark:text-nord-4">Управление проектом (РП)</span>
