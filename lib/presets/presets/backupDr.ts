  ...
  stageTemplates: [
    {
      ...
      requirements:
        'Исполнитель обязан выполнить классификацию защищаемых систем и данных, согласовать целевые RPO/RTO по каждому классу, рассчитать ёмкость хранилища копий с учётом ретенции и дедупликации и разработать схему хранения по правилу 3-2-1.',
      order: 0,
    },
    {
      ...
      requirements:
        'Исполнитель обязан установить сервер управления Кибер Бэкап / RuBackup, узлы хранения и дедупликации и настроить неизменяемые (immutable) хранилища для защиты от шифровальщиков.',
      order: 1,
    },
    {
      ...
      driverFieldKey: 'protected_vms_count',
      requirements:
        'Исполнитель обязан установить агенты и настроить безагентную защиту виртуальных сред, обеспечить консистентные копии СУБД (PostgreSQL / Postgres Pro, 1С) и настроить расписания полных и инкрементальных копий.',
      order: 2,
    },
    {
      ...
      requirements:
        'Исполнитель обязан настроить репликацию резервных копий на вторую площадку, разработать план аварийного восстановления (DRP) с порядком и приоритетами восстановления сервисов и автоматизировать переключение при горячем резерве.',
      order: 3,
    },
    {
      ...
      driverFieldKey: 'protected_vms_count',
      requirements:
        'Исполнитель обязан провести контрольные восстановления каждого класса систем с замером фактических RTO/RPO, разработать регламент регулярных тестов восстановления и инструкции администраторов и провести приёмочные испытания по ПМИ.',
      order: 4,
    },
  ],
  riskTemplates: [
