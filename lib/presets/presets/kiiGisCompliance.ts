  ...
  stageTemplates: [
    {
      ...
      requirements:
        'Исполнитель обязан обеспечить создание комиссии по категорированию, сбор исходных данных, оценку показателей критериев значимости, оформление актов категорирования и сведений для ФСТЭК.',
      order: 0,
    },
    {
      ...
      requirements:
        'Исполнитель обязан выполнить моделирование нарушителя по методике ФСТЭК России 2021 г. и сформировать перечень актуальных угроз и требований к подсистемам СЗИ.',
      order: 1,
    },
    {
      ...
      requirements:
        'Исполнитель обязан установить аппаратные модули доверенной загрузки (АПМДЗ), настроить замки, дискреционное и мандатное разграничение доступа, контроль целостности и аудит.',
      order: 2,
    },
    {
      ...
      driverFieldKey: 'is_systems_count',
      requirements:
        'Исполнитель обязан разработать политику информационной безопасности, регламенты резервного копирования, антивирусного контроля и обращения с криптосредствами, матрицы доступа и приказы о назначении ответственных лиц.',
      order: 3,
    },
    {
      ...
      driverFieldKey: 'kii_objects_count',
      requirements:
        'Исполнитель обязан провести инструментальный контроль полноты реализации принятых мер защиты, сканирование уязвимостей и анализ журналов и обеспечить оформление Аттестата соответствия требованиям безопасности информации.',
      order: 4,
    },
  ],
  riskTemplates: [
