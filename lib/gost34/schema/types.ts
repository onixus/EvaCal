...
export interface SchemaNode {
  ...
  appendix?: boolean;
  /**
   * Приложение — сводный перечень сведений, требующих уточнения. Разделы тела
   * документа ссылаются на него при повторном упоминании того же пробела,
   * вместо того чтобы печатать отметку второй и третий раз.
   */
  gapRegistry?: boolean;
