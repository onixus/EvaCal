  ...
  const mockRequirements: Gost34RequirementItem[] = [
    {
      ...
      description:
        'Поставка программно-аппаратного комплекса (ПАК) в составе 2-х серверов 2U и дисковой полки NVMe/SAS.',
    },
    {
      id: 'req_sw_1',
      code: 'ТР-ПО-01',
      ...
      description:
        'Поставка бессрочных сублицензий на системное ПО с формулярами и сертификатами подлинности.',
    },
    {
      id: 'req_sec_1',
      code: 'ТР-ИБ-01',
    ...
    },
    {
      ...
      description:
        'Внедрение системы аудита доступа к неструктурированным данным Cyberpeak и ГОСТ-VPN шлюзов ViPNet Coordinator.',
    },
    {
      id: 'req_infra_1',
      code: 'ТР-ИНФРА-01',
      ...
      description:
        'Монтаж в стойку 42U, пусконаладочные работы (ПНР) и отказоустойчивая кластеризация СУБД Postgres Pro.',
    },
    {
      id: 'req_api_1',
      code: 'ТР-ИНТ-01',
      ...
      description:
        'Реализация асинхронного обмена справочниками и документами с гарантированной доставкой.',
    },
    {
      id: 'req_arch_1',
      code: 'ТР-АРХ-01',
      ...
      description:
        'Разработка рабочей конструкторской документации и Технического проекта по ГОСТ 34.201.',
    },
    {
      id: 'req_pmi_1',
      code: 'ТР-ПМИ-01',
      ...
      description:
        'Проведение автономных и комплексных приемочных испытаний в соответствии с ГОСТ 34.603.',
    },
  ];
