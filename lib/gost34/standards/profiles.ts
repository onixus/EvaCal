...
const LEGACY_DOCUMENT_TYPES: DocumentProfile[] = [
  ...
  },
  {
    ...
    shortLabel: 'ПЗ',
    uiTitle: 'ПЗ — Пояснительная записка',
    uiDescription: 'Архитектурное обоснование, описание структуры и проектных решений.',
  ...
  },
  {
    ...
    shortLabel: 'АФ',
    uiTitle: 'АФ — Описание функций',
    uiDescription: 'Детальное описание автоматизируемых функций и подсистем.',
  ...
  },
  {
    ...
    shortLabel: 'ПМИ',
    uiTitle: 'ПМИ — Программа и методика испытаний',
    uiDescription: 'Методика приемо-сдаточных испытаний, проверок и сценариев тестирования.',
  ...
  },
  {
    ...
    shortLabel: 'SPEC',
    uiTitle: 'SPEC — Спецификация оборудования и ПО',
    uiDescription: 'Перечень серверного оборудования, системного ПО, СУБД и АРМ пользователей.',
...
export const GOST34_2020_PROFILE: StandardProfile = {
  ...
  citations: {
    ...
    referencesList:
      'ГОСТ 34.602-2020, ГОСТ 34.201-2020, ГОСТ Р 59793-2021, ГОСТ Р 59795-2021, ГОСТ Р 59792-2021, ГОСТ 7.32-2017, ГОСТ Р 56939-2024, Приказы ФСТЭК России № 21 и № 117, Федеральный закон 152-ФЗ.',
