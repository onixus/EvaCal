...
const LEGACY_DOCUMENT_TYPES: DocumentProfile[] = [
  ...
  },
  {
    ...
    uiDescription:
      "Архитектурное обоснование, описание структуры и проектных решений.",
  ...
  },
  {
    ...
    uiDescription:
      "Методика приемо-сдаточных испытаний, проверок и сценариев тестирования.",
  ...
  },
  {
    ...
    uiDescription:
      "Перечень серверного оборудования, системного ПО, СУБД и АРМ пользователей.",
...
export const GOST34_2020_PROFILE: StandardProfile = {
  ...
  documentStandards: [
    ...
    },
    {
      ...
      title:
        "ГОСТ Р 59795-2021 Содержание проектной документации автоматизированных систем",
      version: "2021",
