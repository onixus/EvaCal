...
/**
 * Legacy-профиль ТЗ по ГОСТ 34.602-89.
 *
 * Сохранён дословно для воспроизводимости ранее выпущенных документов и
 * применяется только при явно выбранном профиле `gost34-legacy-89`.
 * Новые проекты используют схему ГОСТ 34.602-2020 (см. `templates/tz34.ts`).
 */
export function buildTZ34LegacySections(payload: Gost34InputPayload): Gost34Section[] {
