...
export function buildSPEC34Sections(
  ...
  const computeResources =
    ctx?.infrastructure?.computeResources || "Не менее 4 vCPU, 8 ГБ RAM";
  ...
  return [
    ...
    },
    {
      ...
      paragraphs: [
        "2.1 Состав системного и прикладного программного обеспечения представлен в Таблице 1.",
      ],
      tables: [
        {
          ...
          headers: [
            "№",
            "Наименование ПО / Компонента",
            "Назначение / Тип лицензии",
            "Количество",
          ],
          rows: [
            ...platforms.map((p, idx) => [
              idx + 1,
              p,
              "Общесистемное ПО / Прикладной компонент",
              "1 инст.",
            ]),
            [
              platforms.length + 1,
              `Прикладное ПО системы «${meta.systemName}»`,
              "Собственная / Лицензия Заказчика",
              "1 лиц.",
            ],
          ],
        },
    ...
    },
    {
      ...
      paragraphs: [
        "3.1 Требования к серверному оборудованию целевого вычислительного контура приведены в Таблице 2.",
      ],
      tables: [
        {
    ...
    },
    {
      ...
      paragraphs: [
        "4.1 Спецификация клиентских рабочих мест пользователей представлена в Таблице 3.",
      ],
      tables: [
        {
          ...
          rows: [
            [
              1,
              "АРМ Пользователя",
              "Стандартный ПК / Дисплей Full HD",
              "Современный веб-браузер",
            ],
            [
              2,
              "АРМ Администратора",
              "Производительный ПК / Дисплей Full HD",
              "Веб-браузер, SSH-клиент",
            ],
          ],
        },
      ],
