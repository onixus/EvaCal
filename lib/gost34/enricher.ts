...
export function getEnrichedGostRequirements(
  ...
  if (opts.fstek_117 === true) {
    reqs.push({
      ...
      category: "security",
      title:
        "Безопасная разработка ПО по Приказу ФСТЭК № 117 и ГОСТ Р 56939-2016",
      description:
  ...
  if (opts.gost_57580 === true) {
    reqs.push({
      ...
      category: "security",
      title:
        "Требования ГОСТ Р 57580.1-2017 и СТО БР ИББС (Финансовые операции)",
      description:
  ...
  if (opts.cb_683p === true) {
    reqs.push({
      ...
      category: "security",
      title:
        "Соблюдение Положения Банка России № 683-П (Кредитные организации)",
      description:
  ...
  if (opts.cb_757p === true) {
    reqs.push({
      ...
      category: "security",
      title:
        "Соблюдение Положения Банка России № 757-П (Некредитные финансовые организации)",
      description:
  ...
  if (opts.fz_187_kii === true) {
    reqs.push({
      ...
      category: "security",
      title:
        "Соблюдение требования Федерального закона № 187-ФЗ «О безопасности КИИ РФ»",
      description:
  ...
  if (opts.fz_152 === true) {
    reqs.push({
      ...
      category: "security",
      title:
        "Локализация баз данных персональных данных на территории РФ (152-ФЗ / 242-ФЗ)",
      description:
  ...
  if (opts.sla_999 === true) {
    reqs.push({
      ...
      title:
        "Непрерывность функционирования и целевые показатели RTO/RPO (SLA 99.9%)",
      description:
